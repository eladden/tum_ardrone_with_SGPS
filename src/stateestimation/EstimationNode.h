...
private:
	...
	ros::Subscriber sgps_sub;
	//ros::Subscriber altm_sub;
	...
	std::string sgps_channel;
	//std::string altm_channel;
...
public:
	...
	//void sgpsCb(const sensor_msgs::NavSatFix::ConstPtr sgps);
        void sgpsCb(const nav_msgs::Odometry::ConstPtr& sgps);
