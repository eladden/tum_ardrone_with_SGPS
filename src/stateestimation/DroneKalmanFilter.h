...
//static const double f_const = 1/298.257224;
...
private:
	...
	//void observeSGPS(TooN::Vector<6> pose);
	void observeSGPS(void);
	...
	double baselineX_SGPS;
	double baselineY_SGPS;
	double baselineZ_SGPS;
...
public:
	...
	static const double R = 6378137.0;    //for the simulated GPS
	...
	//double fix_lon,fix_lat,fix_alt,cosLat,cosLon,sinLat,sinLon,C_4GPS,S_4GPS;
	double x_GPS_obs,y_GPS_obs,z_GPS_obs;
	...
	void addSGPSObservation(TooN::Vector<6> trans, int time);
